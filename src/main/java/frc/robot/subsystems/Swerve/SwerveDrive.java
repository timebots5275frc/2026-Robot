...
public class SwerveDrive extends SubsystemBase {
  private final Translation2d leftFrontWheelLocation  = new Translation2d(DriveConstants.SwerveConstants.ROBOT_SWERVE_LOCATIONS.LEFT_FRONT_WHEEL_X,  DriveConstants.SwerveConstants.ROBOT_SWERVE_LOCATIONS.LEFT_FRONT_WHEEL_Y);
  private final Translation2d rightFrontWheelLocation = new Translation2d(DriveConstants.SwerveConstants.ROBOT_SWERVE_LOCATIONS.RIGHT_FRONT_WHEEL_X, DriveConstants.SwerveConstants.ROBOT_SWERVE_LOCATIONS.RIGHT_FRONT_WHEEL_Y);    
  private final Translation2d rightRearWheelLocation  = new Translation2d(DriveConstants.SwerveConstants.ROBOT_SWERVE_LOCATIONS.RIGHT_REAR_WHEEL_X,  DriveConstants.SwerveConstants.ROBOT_SWERVE_LOCATIONS.RIGHT_REAR_WHEEL_Y);
  private final Translation2d leftRearWheelLocation   = new Translation2d(DriveConstants.SwerveConstants.ROBOT_SWERVE_LOCATIONS.LEFT_REAR_WHEEL_X,   DriveConstants.SwerveConstants.ROBOT_SWERVE_LOCATIONS.LEFT_REAR_WHEEL_Y);

  private final SwerveModule leftFrontSwerveModule  = new SwerveModule(DriveConstants.SwerveConstants.ROBOT_SWERVE_CAN.LEFT_FRONT_DRIVE_MOTOR_ID,  DriveConstants.SwerveConstants.ROBOT_SWERVE_CAN.LEFT_FRONT_STEER_MOTOR_ID, DriveConstants.SwerveConstants.ROBOT_SWERVE_CAN.LEFT_FRONT_STEER_ENCODER_ID,"LF");
  private final SwerveModule rightFrontSwerveModule = new SwerveModule(DriveConstants.SwerveConstants.ROBOT_SWERVE_CAN.RIGHT_FRONT_DRIVE_MOTOR_ID, DriveConstants.SwerveConstants.ROBOT_SWERVE_CAN.RIGHT_FRONT_STEER_MOTOR_ID, DriveConstants.SwerveConstants.ROBOT_SWERVE_CAN.RIGHT_FRONT_STEER_ENCODER_ID,"RF");
  private final SwerveModule rightRearSwerveModule  = new SwerveModule(DriveConstants.SwerveConstants.ROBOT_SWERVE_CAN.RIGHT_REAR_DRIVE_MOTOR_ID,  DriveConstants.SwerveConstants.ROBOT_SWERVE_CAN.RIGHT_REAR_STEER_MOTOR_ID, DriveConstants.SwerveConstants.ROBOT_SWERVE_CAN.RIGHT_REAR_STEER_ENCODER_ID,"RR");
  private final SwerveModule leftRearSwerveModule   = new SwerveModule(DriveConstants.SwerveConstants.ROBOT_SWERVE_CAN.LEFT_REAR_DRIVE_MOTOR_ID,   DriveConstants.SwerveConstants.ROBOT_SWERVE_CAN.LEFT_REAR_STEER_MOTOR_ID, DriveConstants.SwerveConstants.ROBOT_SWERVE_CAN.LEFT_REAR_STEER_ENCODER_ID,"LR");
