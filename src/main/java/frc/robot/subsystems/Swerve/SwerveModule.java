...
public class SwerveModule {
    ...
    // big neo Steer, neo vortex drive
    ...
    public SwerveModule(int driveMotorID, int steerMotorID, int steerEncoderId, String n) {
        ...
        /// PID Controllers ///
        steerAnglePID = new PIDController(DriveConstants.SwerveConstants.PID_Encoder_Steer.p, DriveConstants.SwerveConstants.PID_Encoder_Steer.i, DriveConstants.SwerveConstants.PID_Encoder_Steer.d);
        ...
        steerClosedLoopConfig.pidf(DriveConstants.SwerveConstants.PID_SparkMax_Steer.p, DriveConstants.SwerveConstants.PID_SparkMax_Steer.i, DriveConstants.SwerveConstants.PID_SparkMax_Steer.d, DriveConstants.SwerveConstants.PID_SparkMax_Steer.kS); // was kFF
        steerClosedLoopConfig.iZone(DriveConstants.SwerveConstants.PID_SparkMax_Steer.iz);
        ...
        driveClosedLoopConfig.pidf(DriveConstants.SwerveConstants.PID_SparkFlex_Drive.p, DriveConstants.SwerveConstants.PID_SparkFlex_Drive.i, DriveConstants.SwerveConstants.PID_SparkFlex_Drive.d, DriveConstants.SwerveConstants.PID_SparkFlex_Drive.kS); // was kFF TODO: what
        driveClosedLoopConfig.iZone(DriveConstants.SwerveConstants.PID_SparkFlex_Drive.iz);
    ...
    public double driveRpmFromSpeed(double speedMetersPerSecond) {
        double rpm = speedMetersPerSecond * 60.0 / DriveConstants.WHEEL_CIRCUMFERENCE / DriveConstants.SwerveConstants.DRIVE_GEAR_RATIO;
    ...
    public double speedFromDriveRpm(double rpm) {
        double speedMetersPerSecond = rpm * DriveConstants.SwerveConstants.DRIVE_GEAR_RATIO * DriveConstants.WHEEL_CIRCUMFERENCE / 60.0;
        return -1 * speedMetersPerSecond; // Rotation reversed due to gears.
    }

    public SwerveModulePosition getPosition() {
        double distance = Math.abs(driveNEOVortexMotorEncoder.getPosition()*DriveConstants.SwerveConstants.DRIVE_GEAR_RATIO * DriveConstants.WHEEL_CIRCUMFERENCE);
