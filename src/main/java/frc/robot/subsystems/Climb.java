...
public class Climb extends SubsystemBase {
    ...
    public Climb() {
        ...
        climbMotor2 = new SparkMax(Constants.ClimbConstants.MOTOR2_ID, MotorType.kBrushless);
        Constants.ClimbConstants.CLIMB_MOTOR_PID.setSparkMaxPID(climbMotor2, ResetMode.kResetSafeParameters, PersistMode.kPersistParameters);
